...
namespace SOD.View
{
    public static class NavigationRegister
    {
        public static void Register(INavigationService navigationService)
        {
            ...
            //navigationService.RegisterView("Testing", "SelectProgramm", new Testing.MultiPostBench.SelectProgrammMethodicsView(), typeof(ViewModels.Testing.MultiPostBench.SelectProgrammMethodicsViewModel));
            //navigationService.RegisterView("Testing", "EditProgrammMethodics", new Testing.MultiPostBench.ProgrammMethodicsEditor.EditProgrammMethodicsView(), null);
            //navigationService.RegisterView("Testing", "SelectValve", new Testing.MultiPostBench.SelectVavleView(), typeof(ViewModels.Testing.MultiPostBench.SelectValveViewModel));
            //navigationService.RegisterView("Testing", "TestingValves", new Testing.ValvesView(), typeof(ViewModels.Testing.ValvesViewModel));
            //navigationService.RegisterView("Testing", "TestParameters", new Testing.MultiPostBench.TestParametersView(), typeof(ViewModels.Testing.MultiPostBench.TestParametersViewModel));
