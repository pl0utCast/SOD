...
{
	public class CRSBenchSettingsViewModel : ReactiveObject, IActivatableViewModel
	{
		...
		public void Save()
		{
			...
			Parameters.Save();
			_bench?.SaveSettings();
			_dialogService.ShowMessage(_localizationService["Settings.Bench.CrsBenchSettingsView.SaveSettings"]);
		}
