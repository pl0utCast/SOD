...
namespace SOD.ViewModels.Settings.Bench.SODBench
{
	...
	{
		private readonly App.Benches.SODBench.Settings _settings;
		public ParametersSettingsViewModel(IDialogService dialogService, App.Benches.SODBench.Settings settings, IUserService userService)
		{
