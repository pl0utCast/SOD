...
{
    public class LeakControlCavityCommandViewModel : BaseCommandViewModel
    {
        public LeakControlCavityCommandViewModel(CommandConfig commandConfig) : base(commandConfig)
        {
            Notify(true);
            if (commandConfig.Type != CommandType.LeakControlCavity) throw new ArgumentException("command is not support");
