...
{
    public class FillingCommandViewModel : BaseCommandViewModel
    {
        public FillingCommandViewModel(CommandConfig commandConfig) : base(commandConfig)
        {
            if (commandConfig.Type != CommandType.Filling) throw new ArgumentException("Command not support");
