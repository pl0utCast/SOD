...
{
    public class TestMediumCommandViewModel : BaseCommandViewModel
    {
        public TestMediumCommandViewModel(CommandConfig commandConfig) : base(commandConfig)
        {
            Notify(true);

            if (commandConfig.Type == CommandType.TestMedium)
            {
